  ...
  const columns: ColumnsType<Resume> = [
    ...
    },
    {
      ...
      render: (status: string) => (
        <Tag color={status === "Completed" ? "green" : status === "Pending" ? "blue" : "default"}>
          {status || "Processing"}
        </Tag>
      ),
    },
    {
      ...
      render: (score: number | null) =>
        score != null ? (
          <Tag color={score >= 70 ? "green" : score >= 40 ? "orange" : "red"}>{score}</Tag>
        ) : (
        ...
        title={
          <div className="flex justify-between items-center w-full">
            <div className="flex items-center gap-2">
              <Button className="company-btn" icon={<ArrowLeftOutlined />} onClick={() => navigate("/company/ai-screening")}/>
                  ...
                  {selectedResume.scoreDetails.map((detail) => (
                    ...
                    >
                      <div style={{ marginBottom: 8 }}>
                        ...
                        <Tag
                          color={detail.score >= 70 ? "green" : detail.score >= 40 ? "orange" : "red"}
                          style={{ marginLeft: 8 }}
                        >
                          Score: {detail.score}
                        </Tag>
